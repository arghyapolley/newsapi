        ...
        <div class="row">
            <div v-for="article in articles" class="col-md-3" style="margin-right: 5%; margin-bottom: 5%">
                <b-card :title="article.title"
                    ...
                    <ahref = "article.url" target="_blank" class="card-link" >Read Full Story</ahref>
                </b-card>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        loadArticles: function() {
            var url = 'https://newsapi.org/v2/top-headlines?country=gb&apiKey='+'e5b693d596ac46ac833bdf1e25b9cbcf'
